...
public class WriteJSON extends Thread {
	...
	private Map<Integer, SubNode> nodeCollumn(List<SubNode> subNode) {
		Map<Integer, SubNode> mn = new HashMap<Integer, SubNode>();
	...
	private void writeSubNode(int startColumn, int endColumn)
		...
		Map<Integer, List<Object>> subTree = new LinkedHashMap<Integer, List<Object>>();
		List<Object> branch;
		int objCount = 0;
		...
		for (int i = 0; i < objCount; i++) {
			...
			for (Map.Entry<Integer, List<Object>> entry : subTree.entrySet()) {
				try {
					...
					// That means this collumn don't have value for specific
	...
	private List<Object> condensedBranch(List<Object> branch) {
		...
		Set<Integer> indexTocheck = new HashSet<Integer>();
		Map<Integer, Integer> indexDuplicates = new HashMap<Integer, Integer>();
